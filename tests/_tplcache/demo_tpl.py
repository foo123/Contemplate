    ...
    class Contemplate_demo_Cached(Contemplate):
        ...
        def _blockfn_Block3(self, __instance__):
            ...
            if ( len(_loopObj2) > 0  ):
                ...
                if isinstance(_loopObj2, list): _loopObj1 = enumerate(_loopObj2)
                else: _loopObj1 = _loopObj2.items()
        ...
        def _blockfn_Block2(self, __instance__):
            ...
            if ( len(_loopObj2) > 0  ):
                ...
                for index,value in _loopObj1 :
                    __instance__.data['index'] = index
                    __instance__.data['value'] = value
                     
                    __p__ += '' + "\n" + '        [' + str( __instance__.data['index'] ) + '] = <strong>' + str( __instance__.data['value'] ) + '</strong><br /> ' + "\n" + '    ' 
             
            __p__ += '' + "\n" + '    ' + "\n" + '    <br /><br />' + "\n" + '    ' + "\n" + '    <strong>A select box</strong><br />' + "\n" + '    ' + str( Contemplate.htmlselect(__instance__.data['select_data'], __instance__.data['select_options']) ) + '' + "\n" + '' + "\n" + '    <br /><br />' + "\n" + '    ' + "\n" + '    <strong>A table with alternative format</strong><br />' + "\n" + '    ' + str( Contemplate.htmltable(__instance__.data['table_data'], {"header" : True}) ) + '' + "\n" + '' + "\n" + '    <br /><br />' + "\n" + '    ' + "\n" + '    <strong>A select box with alternative format</strong><br />' + "\n" + '    ' + str( Contemplate.htmlselect(__instance__.data['select_data'], {             "optgroups" : ["group1", "group2", "group3"],             "selected" : 3,             "multiple" : False,             "style" : "width:200px;",             "foo123" : ":,=>"         }) ) + '' + "\n" + '    ' + "\n" + '    <br /><br />' + "\n" + '    <!-- include a (sub-)template file -->' + "\n" + '     <!-- print a localized date php-style -->' + "\n" + '<strong>A (localized) date, PHP-style</strong><br />' + "\n" + '' + str( Contemplate.ldate("M, d", Contemplate.now()) ) + '' + "\n" + '' 
