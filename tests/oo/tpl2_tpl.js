...
!function (root, moduleName, moduleDefinition) {
...
}(this, 'Contemplate_tpl2_Cached', function( ){
    "use strict";
    return function( Contemplate ) {
    /* Contemplate cached template 'tpl2' */
    
    /* constructor */
    function Contemplate_tpl2_Cached(id)
    {
        var self = this;
    ...
    Contemplate_tpl2_Cached.prototype = Object.create(Contemplate.Template.prototype);
    /* tpl render method */
    Contemplate_tpl2_Cached.prototype.render = function( data, __i__ ) {
        "use strict";
        var self = this, __p__ = '';
        __i__ = __i__ || self;
