...
# Contemplate cached template 'folder2/tpl2.html'
def __getTplClass__(Contemplate):
    # extends the main Contemplate.Template class
    class Contemplate_tpl2_html__global(Contemplate.Template):
        'Contemplate cached template folder2/tpl2.html'
        # constructor
        def __init__(self, id=None):
            self_ = self
            super(Contemplate_tpl2_html__global, self_).__init__( id )
