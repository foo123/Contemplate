...
}('undefined' !== typeof self ? self : this,'Contemplate_tpl3__global',function() {
"use strict";
return function(Contemplate) {
/* Contemplate cached template 'tpl3', constructor */
function Contemplate_tpl3__global(id)
{
    var self = this;
    ...
    self._extendsTpl = 'tpl2';
    self._usesTpl = [];
    /* extend tpl assign code ends here */
}
/* extends main Contemplate.Template class */
Contemplate_tpl3__global.prototype = Object.create(Contemplate.Template.prototype);
/* render method */
Contemplate_tpl3__global.prototype.render = function(data, __i__) {
    "use strict";
