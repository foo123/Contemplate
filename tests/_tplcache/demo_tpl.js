       ...
       /* tpl-defined blocks render code starts here */
        ...
        _blocks = { 
            ...
            'Block3': function(__i__) {
                ...
                var _O4 = __i__.data['users'];
                if ( _O4 && Object.keys(_O4).length )
                {
                   var _K5;
                   for ( _K5 in _O4 )
                   {
                       if ( Contemplate.hasOwn(_O4, _K5) )
                       {
                          var _V6 = _O4[_K5];
                          __i__.data['i'] = _K5; __i__.data['usergroup'] = _V6;
            ...
            'Block2': function(__i__) {
                ...
                if ( _O1 && Object.keys(_O1).length )
                {
                   ...
                   for ( _K2 in _O1 )
                   {
                       ...
                       {
                          var _V3 = _O1[_K2];
                          __i__.data['index'] = _K2; __i__.data['value'] = _V3;
